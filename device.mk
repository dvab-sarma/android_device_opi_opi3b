...
#     external/libcamera/src/ipa/opi/pisp/data/imx219.json:$(TARGET_COPY_OUT_VENDOR)/etc/libcamera/ipa/opi/pisp/imx219.json \
#     external/libcamera/src/ipa/opi/pisp/data/imx219_noir.json:$(TARGET_COPY_OUT_VENDOR)/etc/libcamera/ipa/opi/pisp/imx219_noir.json \
#     external/libcamera/src/ipa/opi/pisp/data/imx296.json:$(TARGET_COPY_OUT_VENDOR)/etc/libcamera/ipa/opi/pisp/imx296.json \
#     external/libcamera/src/ipa/opi/pisp/data/imx296_mono.json:$(TARGET_COPY_OUT_VENDOR)/etc/libcamera/ipa/opi/pisp/imx296_mono.json \
#     external/libcamera/src/ipa/opi/pisp/data/imx477.json:$(TARGET_COPY_OUT_VENDOR)/etc/libcamera/ipa/opi/pisp/imx477.json \
#     external/libcamera/src/ipa/opi/pisp/data/imx477_noir.json:$(TARGET_COPY_OUT_VENDOR)/etc/libcamera/ipa/opi/pisp/imx477_noir.json \
#     external/libcamera/src/ipa/opi/pisp/data/imx477_scientific.json:$(TARGET_COPY_OUT_VENDOR)/etc/libcamera/ipa/opi/pisp/imx477_scientific.json \
#     external/libcamera/src/ipa/opi/pisp/data/imx500.json:$(TARGET_COPY_OUT_VENDOR)/etc/libcamera/ipa/opi/pisp/imx500.json \
#     external/libcamera/src/ipa/opi/pisp/data/imx519.json:$(TARGET_COPY_OUT_VENDOR)/etc/libcamera/ipa/opi/pisp/imx519.json \
#     external/libcamera/src/ipa/opi/pisp/data/imx708.json:$(TARGET_COPY_OUT_VENDOR)/etc/libcamera/ipa/opi/pisp/imx708.json \
#     external/libcamera/src/ipa/opi/pisp/data/imx708_noir.json:$(TARGET_COPY_OUT_VENDOR)/etc/libcamera/ipa/opi/pisp/imx708_noir.json \
#     external/libcamera/src/ipa/opi/pisp/data/imx708_wide.json:$(TARGET_COPY_OUT_VENDOR)/etc/libcamera/ipa/opi/pisp/imx708_wide.json \
#     external/libcamera/src/ipa/opi/pisp/data/imx708_wide_noir.json:$(TARGET_COPY_OUT_VENDOR)/etc/libcamera/ipa/opi/pisp/imx708_wide_noir.json \
#     external/libcamera/src/ipa/opi/pisp/data/ov5647.json:$(TARGET_COPY_OUT_VENDOR)/etc/libcamera/ipa/opi/pisp/ov5647.json \
#     external/libcamera/src/ipa/opi/pisp/data/ov5647_noir.json:$(TARGET_COPY_OUT_VENDOR)/etc/libcamera/ipa/opi/pisp/ov5647_noir.json \
#     external/libcamera/src/ipa/opi/pisp/data/ov64a40.json:$(TARGET_COPY_OUT_VENDOR)/etc/libcamera/ipa/opi/pisp/ov64a40.json
...
# CEC
PRODUCT_PACKAGES += \
    com.android.hardware.tv.hdmi.connection.opi3b
...
# ! --------- TODO : need to change this to panfrost
PRODUCT_PACKAGES += \
    vulkan.panfrost
...
# Health
PRODUCT_PACKAGES += \
    com.android.hardware.health.opi3b
...
PRODUCT_COPY_FILES += \
 ...
 # Lights
 PRODUCT_PACKAGES += \
     com.android.hardware.light.opi3b
...
# Ramdisk
PRODUCT_COPY_FILES += \
    $(DEVICE_PATH)/ramdisk/fstab.opi3b:$(TARGET_COPY_OUT_RAMDISK)/fstab.opi3b \
...
$(call inherit-product, $(SRC_TARGET_DIR)/product/emulated_storage.mk)
 ...
 # Suspend
 PRODUCT_PACKAGES += \
     com.android.hardware.suspend_blocker.opi3b
...
# !------ TODO : need to check and change to opi
# USB
PRODUCT_PACKAGES += \
    com.android.hardware.usb \
    com.android.hardware.usb.gadget.opi3b
